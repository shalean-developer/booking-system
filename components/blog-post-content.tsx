...
function sanitizeBlogContent(content: string): string {
  ...
  sanitized = sanitized.replace(/href=["']\/blog\/shalean\.co\.za\/booking\/service\/select["']/gi, 'href="/booking/service/standard/details"');
  ...
  sanitized = sanitized.replace(/href=["']\/booking["']/gi, 'href="/booking/service/standard/details"');
