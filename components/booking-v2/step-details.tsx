...
export function StepDetails() {
  ...
  }, [state.service, state.bathrooms, router, getSchedulePath]);
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl shadow-md p-4 md:p-6 border border-slate-100 max-w-[576px] mx-auto w-full"
    >
            ...
            {allowedExtras.map((extra) => {
              ...
              return (
                <motion.div
                  ...
                  tabIndex={0}
                  className={cn(
                    'group relative flex cursor-pointer flex-col items-center gap-3 rounded-2xl border px-3 py-4 text-center transition-all focus:outline-none focus:ring-2 focus:ring-primary/25 focus:ring-offset-2 min-h-[160px]',
                    isSelected
