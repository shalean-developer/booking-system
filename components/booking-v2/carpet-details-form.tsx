...
interface CarpetDetailsFormProps {
  carpetDetails: CarpetDetails;
  onCarpetDetailsChange: (details: CarpetDetails) => void;
}

export function CarpetDetailsForm({
  carpetDetails,
  onCarpetDetailsChange,
}: CarpetDetailsFormProps) {
  const updateField = <K extends keyof CarpetDetails>(field: K, value: CarpetDetails[K]) => {
    ...
    onCarpetDetailsChange(updated);
  };

  return (
    <section aria-labelledby="carpet-details" className="space-y-6">
      <h3 id="carpet-details" className="text-base font-semibold text-slate-900">
        Carpet Details
      </h3>
      ...
      {carpetDetails.hasFittedCarpets && (
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="numberOfRooms" className="text-sm font-semibold text-gray-900">
          ...
          >
            <SelectTrigger id="numberOfRooms" className="h-11">
      ...
      {carpetDetails.hasLooseCarpets && (
        <motion.div
          ...
          className="space-y-2"
        >
          <Label htmlFor="numberOfLooseCarpets" className="text-sm font-semibold text-gray-900">
          ...
          >
            <SelectTrigger id="numberOfLooseCarpets" className="h-11">
