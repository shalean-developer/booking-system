...
export const metadata: Metadata = createMetadata({
  ...
  description: "Professional window cleaning services for homes and offices. Crystal clear windows with streak-free results. Interior and exterior cleaning, window frame cleaning, screen maintenance, and safety equipment available.",
