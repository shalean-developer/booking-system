        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Pick a cleaning package and match it with a Port Elizabeth team that knows your neighbourhood. Whether you need <Link href="/services/regular-cleaning" className="text-primary hover:underline">regular cleaning</Link>, <Link href="/services/deep-cleaning" className="text-primary hover:underline">deep cleaning</Link>, or <Link href="/services/one-time-cleaning" className="text-primary hover:underline">one-time cleaning</Link>, we've got you covered.
            </p>
          </div>
