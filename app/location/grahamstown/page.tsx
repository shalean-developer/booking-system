...
const coreServices = [
  {
    ...
    description: "Recurring housekeeping tailored to student accommodation, apartments, and family homes.",
    href: "/services/regular-cleaning",
    cta: "View Regular Cleaning",
  },
  {
    title: "Deep Cleaning",
    description: "Thorough deep cleans that refresh every corner of your property.",
    href: "/services/deep-specialty",
    cta: "Explore Deep Cleaning",
  },
  {
    title: "Move In/Out",
    description: "Stress-free move cleans for Grahamstown landlords, hosts, and relocating families.",
...
export const metadata: Metadata = createMetadata({
  title: "Grahamstown Cleaning Services | Shalean",
  description: "Professional cleaning services in Grahamstown. Expert cleaners available for regular maintenance, deep cleaning, move-in/out, and Airbnb turnover services throughout Grahamstown.",
  canonical: generateCanonical("/location/grahamstown"),
});

export default function GrahamstownPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="mb-6 text-5xl font-bold text-gray-900 sm:text-6xl">
              Grahamstown <span className="text-primary">Cleaning Services</span>
            </h1>
            <p className="mx-auto mb-8 max-w-3xl text-xl text-gray-600">
              Professional cleaning services available throughout Grahamstown.
              Book your trusted cleaner today! We also serve <Link href="/location/east-london" className="text-primary hover:underline">East London</Link>, <Link href="/location/port-elizabeth" className="text-primary hover:underline">Port Elizabeth</Link>, and <Link href="/location/jeffreys-bay" className="text-primary hover:underline">Jeffreys Bay</Link>. Explore our <Link href="/services" className="text-primary hover:underline">cleaning services</Link> including <Link href="/services/regular-cleaning" className="text-primary hover:underline">regular cleaning</Link>, <Link href="/services/deep-cleaning" className="text-primary hover:underline">deep cleaning</Link>, and <Link href="/services/move-turnover" className="text-primary hover:underline">move-in/out cleaning</Link>.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Popular Cleaning Services in Grahamstown
            </h2>
            <p className="text-lg text-gray-600">
              Pick a cleaning package and match it with a Grahamstown team that knows your neighbourhood. Whether you need <Link href="/services/regular-cleaning" className="text-primary hover:underline">regular cleaning</Link>, <Link href="/services/deep-cleaning" className="text-primary hover:underline">deep cleaning</Link>, or <Link href="/services/one-time-cleaning" className="text-primary hover:underline">one-time cleaning</Link>, we've got you covered.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 to-primary/10">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            We're here to help keep your Grahamstown home spotless. Get in touch to check availability.
          </p>
