...
const coreServices = [
  {
    ...
    description: "Recurring housekeeping tailored to beachfront properties, apartments, and family homes.",
  ...
  {
    title: "Move In/Out",
    description: "Stress-free move cleans for Jeffreys Bay landlords, hosts, and relocating families.",
...
export const metadata: Metadata = createMetadata({
  title: "Jeffreys Bay Cleaning Services | Shalean",
  description: "Professional cleaning services in Jeffreys Bay. Expert cleaners available for regular maintenance, deep cleaning, move-in/out, and Airbnb turnover services throughout Jeffreys Bay.",
  canonical: generateCanonical("/location/jeffreys-bay"),
});

export default function JeffreysBayPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="mb-6 text-5xl font-bold text-gray-900 sm:text-6xl">
              Jeffreys Bay <span className="text-primary">Cleaning Services</span>
            </h1>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 to-primary/10">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            We're here to help keep your Jeffreys Bay home spotless. Get in touch to check availability.
          </p>
