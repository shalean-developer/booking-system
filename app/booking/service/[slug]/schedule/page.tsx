...
export default function SchedulePage() {
  ...
  // Ensure we're on step 3 and have the correct service selected
  useEffect(() => {
    ...
    // If not on step 3, redirect to the correct step
    if (state.step !== 3) {
      if (state.step === 1) {
  ...
  // If no valid service from slug or not on step 3, don't render yet (will redirect)
